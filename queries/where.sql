...
from sales.customers --estados escritos em siglas: SC
...
from sales.customers -- como esta escrito a data 2002-03-01

select email, state , birth_date
from sales.customers
where (state = 'SC' or state = 'MS') and birth_date < '1994-05-22'
